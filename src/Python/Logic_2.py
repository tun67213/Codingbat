...
def lucky_sum(a: int, b: int, c: int) -> int:
    raise NotImplementedError("lucky_sum not implemented yet")
...
def main():
    ...
    print(f"make_bricks(0, 3, 10) -> {make_bricks(0, 3, 10)}")
    print(f"make_bricks(1, 4, 12) -> {make_bricks(1, 4, 12)}")
    ...
    print(f"lone_sum(1, 3, 1) -> {lone_sum(1, 3, 1)}")

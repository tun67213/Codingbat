...
def cigar_party(cigars: int, is_weekend: bool) -> bool:
    raise NotImplementedError("cigar_party not implemented yet")
...
def squirrel_play(temp: int, is_summer: bool) -> bool:
    raise NotImplementedError("squirrel_play not implemented yet")
...
def main():
    ...
    print(f"caught_speeding(65, True) -> {caught_speeding(65, True)}")
    ...
    print(f"in1to10(-1, False) -> {in1to10(0, False)}")
    print(f"in1to10(-1, True) -> {in1to10(-1, True)}")

...
public class Map_2
{
	...
	public void main(String[] args)
	{
		...
		welcome();
		printFunction("word0");
		System.out.println("word0([\"a\", \"b\", \"a\", \"b\"]) → " + toStringStringBoolean(word0(new String[] {"a", "b", "a", "b"})));
		System.out.println("word0([\"a\", \"b\", \"a\", \"c\", \"b\"]) → " + toStringStringBoolean(word0(new String[] {"a", "b", "a", "c", "b"})));
		System.out.println("word0([\"c\", \"b\", \"a\"]) → " + toStringStringBoolean(word0(new String[] {"c", "b", "a"})));
		System.out.println("word0([\"c\", \"c\", \"c\", \"c\"]) → " + toStringStringBoolean(word0(new String[] {"c", "c", "c", "c"})));
		System.out.println("word0([]) → " + toStringStringBoolean(word0(new String[] {})));
		printFunction("wordLen");
		System.out.println("wordLen([\"a\", \"bb\", \"a\", \"bb\"]) → " + toStringStringBoolean(wordLen(new String[] {"a", "bb", "a", "bb"})));
		System.out.println("wordLen([\"this\", \"and\", \"that\", \"and\"]) → " + toStringStringBoolean(wordLen(new String[] {"this", "and", "that", "and"})));
		System.out.println("wordLen([\"code\", \"code\", \"code\", \"bug\"]) → " + toStringStringBoolean(wordLen(new String[] {"code", "code", "code", "bug"})));
		System.out.println("wordLen([]) → " + toStringStringBoolean(wordLen(new String[] {})));
		System.out.println("wordLen([\"z\"]) → " + toStringStringBoolean(wordLen(new String[] {"z"})));
		printFunction("pairs");
		...
		System.out.println("wordCount([\"a\", \"b\", \"a\", \"c\", \"b\"]) → " + toStringStringBoolean(wordCount(new String[] {"a", "b", "a", "c", "b"})));
		System.out.println("wordCount([\"c\", \"b\", \"a\"]) → " + toStringStringBoolean(wordCount(new String[] {"c", "b", "a"})));
		System.out.println("wordCount([\"c\", \"c\", \"c\", \"c\"]) → " + toStringStringBoolean(wordCount(new String[] {"c", "c", "c", "c"})));
		System.out.println("wordCount([]) → " + toStringStringBoolean(wordCount(new String[] {})));
		System.out.println("wordCount([\"this\", \"and\", \"this\", \"\"]) → " + toStringStringBoolean(wordCount(new String[] {"this", "and", "this", ""})));
		System.out.println("wordCount([\"x\", \"y\", \"x\", \"Y\", \"X\"]) → " + toStringStringBoolean(wordCount(new String[] {"x", "y", "x", "Y", "X"})));
		System.out.println("wordCount([\"123\", \"0\", \"123\", \"1\"]) → " + toStringStringBoolean(wordCount(new String[] {"123", "0", "123", "1"})));
		System.out.println("wordCount([\"d\", \"a\", \"e\", \"d\", \"a\", \"d\", \"b\", \"b\", \"z\", \"a\", \"a\", \"b\", \"z\", \"x\", \"b\", \"f\", \"x\", \"two\", \"b\", \"one\", \"two\"]) → " + toStringStringBoolean(wordCount(new String[] {"d", "a", "e", "d", "a", "d", "b", "b", "z", "a", "a", "b", "z", "x", "b", "f", "x", "two", "b", "one", "two"})));
		System.out.println("wordCount([\"apple\", \"banana\", \"apple\", \"apple\", \"tea\", \"coffee\", \"banana\"]) → " + toStringStringBoolean(wordCount(new String[] {"apple", "banana", "apple", "apple", "tea", "coffee", "banana"})));

 ...
 * @code This class implements all functions from Array-1 for Java in Codingbat.com
 */
public class Array_1
{
	...
	/**
	 * @return a meaningful string representing the returned array
	 * @code This function is to prevent the annoying warning that appears
	 */
	@Override
...
//		return Arrays.toString(this.array);
	...
	public void main(String[] args)
	{
		...
		System.out.println("firstLast6([3, 6]) --> " + firstLast6(new int[] {3, 6, 1}));
		...
		System.out.println("firstLast6([1, 2, 3, 4, 5, 6]) --> " + firstLast6(new int[] {1, 2, 3, 4, 5, 6}));
		...
		System.out.println("reverse3([3, 11, 9]) --> " + Arrays.toString(reverse3(new int[] {3, 11, 9})));
		...
		System.out.println("double23([3, 2]) --> " + double23(new int[] {3, 3}));
		...
		System.out.println("start1([1, 2, 3], [1, 3]) --> " + Arrays.toString(start1(new int[] {1, 2, 3}, new int[] {1, 3})));
		System.out.println("start1([7, 2, 3], [1]) --> " + Arrays.toString(start1(new int[] {7, 2, 3}, new int[] {1})));
		System.out.println("start1([1, 2], []) --> " + Arrays.toString(start1(new int[] {1, 2}, new int[] {})));
		System.out.println("start1([], [1, 2]) --> " + Arrays.toString(start1(new int[] {}, new int[] {1, 2})));
		System.out.println("start1([7], []) --> " + Arrays.toString(start1(new int[] {7}, new int[] {})));
		System.out.println("start1([7], [1]) --> " + Arrays.toString(start1(new int[] {7}, new int[] {1})));
		System.out.println("start1([1], [1]) --> " + Arrays.toString(start1(new int[] {1}, new int[] {1})));
		System.out.println("start1([7], [8]) --> " + Arrays.toString(start1(new int[] {7}, new int[] {8})));
		System.out.println("start1([], []) --> " + Arrays.toString(start1(new int[] {}, new int[] {})));
		System.out.println("start1([1, 3], [1]) --> " + Arrays.toString(start1(new int[] {1, 3}, new int[] {1})));

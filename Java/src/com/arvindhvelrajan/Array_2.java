 ...
 * @code This class implements all functions from Array-2 for Java in Codingbat.com
 */
public class Array_2
{
	/**
	 * This function will print the class name, informing the user running main that this is the Array-2 module.
	 */
	public void welcome()
	{
		System.out.println("\n\nArray-2 Functions\n");
	 ...
	 * You do not need a separate if-statement for the length-0 case; the for-loop should naturally execute 0 times in
	 ...
	 * @code This function is to run all the test cases, but have it accessible as a function so that the user knows
	...
	public void main(String[] args)
	{
		...
		System.out.println("bigDiff([2]) --> " + bigDiff(new int[] {2, 2}));
		...
		System.out.println("centeredAverage([4, 4, 4, 1, 5]) --> " + centeredAverage(new int[] {4, 4, 4, 4, 5}));
		...
		System.out.println("sum13([0]) --> " + sum13(new int[] {}));
		...
		System.out.println("sum67([2, 7, 6, 2, 6, 2, 7]) --> " + sum67(new int[] {2, 7, 6, 2, 6, 7, 2, 7}));
		...
		System.out.println("sum28([2, 3, 2, 2, 4, 2, 2]) --> " + sum28(new int[] {2, 3, 2, 2, 4, 2}));
		...
		System.out.println("only14([1, 1, 1]) --> " + only14(new int[] {1, 1}));
		...
		System.out.println("fizzArray2(1) --> " + Arrays.toString(fizzArray2(1)));
		System.out.println("fizzArray2(0) --> " + Arrays.toString(fizzArray2(0)));
		System.out.println("fizzArray2(7) --> " + Arrays.toString(fizzArray2(7)));
		System.out.println("fizzArray2(9) --> " + Arrays.toString(fizzArray2(9)));
		System.out.println("fizzArray2(11) --> " + Arrays.toString(fizzArray2(11)));
		printFunction("no14");
		...
		System.out.println("sameEnds([], 0) --> " + sameEnds(new int[] {1}, 0));
		...
		System.out.println("post4([4, 4]) --> " + Arrays.toString(post4(new int[] {4, 4, 3})));
		...
		System.out.println("fizzBuzz(1, 6) --> " + Arrays.toString(fizzBuzz(1, 6)));
		System.out.println("fizzBuzz(1, 8) --> " + Arrays.toString(fizzBuzz(1, 8)));
		System.out.println("fizzBuzz(1, 11) --> " + Arrays.toString(fizzBuzz(1, 11)));
		System.out.println("fizzBuzz(1, 16) --> " + Arrays.toString(fizzBuzz(1, 16)));
		System.out.println("fizzBuzz(1, 4) --> " + Arrays.toString(fizzBuzz(1, 4)));
		System.out.println("fizzBuzz(1, 2) --> " + Arrays.toString(fizzBuzz(1, 2)));
		System.out.println("fizzBuzz(50, 56) --> " + Arrays.toString(fizzBuzz(50, 56)));
		System.out.println("fizzBuzz(15, 17) --> " + Arrays.toString(fizzBuzz(15, 17)));
		System.out.println("fizzBuzz(30, 36) --> " + Arrays.toString(fizzBuzz(30, 36)));
		System.out.println("fizzBuzz(1000, 1006) --> " + Arrays.toString(fizzBuzz(1000, 1006)));
		System.out.println("fizzBuzz(99, 102) --> " + Arrays.toString(fizzBuzz(99, 102)));
		System.out.println("fizzBuzz(14, 20) --> " + Arrays.toString(fizzBuzz(14, 20)));
	}
}

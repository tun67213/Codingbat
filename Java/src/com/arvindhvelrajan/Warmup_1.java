 ...
 * @code This class implements all functions in Warmup-1 from codingbat.com
 */
...
//		return front3Recursive(str);
	...
	{
		int numOne = Math.abs(a - 10);
		int numTwo = Math.abs(b - 10);
		if(numOne == numTwo)
		{
			return 0;
		}
...
//		return endUpRecursive(str);
	...
	public void main(String[] args)
	{
		...
		System.out.println("makes10(12, -1) --> " + makes10(12, -1));
		...
		System.out.println("delDel(\"adelbc\") --> \"" + delDel("abc") + "\"");
